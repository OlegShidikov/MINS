...
/* Definitions for gyroModuleTask */
osThreadId_t gyroModuleTaskHandle;
const osThreadAttr_t gyroModuleTask_attributes = {
  .name = "gyroModuleTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
/* Definitions for calculationQueue */
osMessageQueueId_t calculationQueueHandle;
const osMessageQueueAttr_t calculationQueue_attributes = {
  .name = "calculationQueue"
};
/* Definitions for bridgeQueue */
osMessageQueueId_t bridgeQueueHandle;
const osMessageQueueAttr_t bridgeQueue_attributes = {
  .name = "bridgeQueue"
};
/* Definitions for gyroModuleQueue */
osMessageQueueId_t gyroModuleQueueHandle;
const osMessageQueueAttr_t gyroModuleQueue_attributes = {
  .name = "gyroModuleQueue"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_startGyroModuleTask */
/**
* @brief Function implementing the gyroModuleTask thread.
* @param argument: Not used
* @retval None
*/
...
void startGyroModuleTask(void *argument)
{
  ...
  /* USER CODE END startGyroModuleTask */
}
